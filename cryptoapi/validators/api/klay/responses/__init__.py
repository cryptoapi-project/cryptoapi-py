...
class Responses:
    ...
    def __init__(self, validator: Callable, utils: Any) -> None:
        self.get_network_info: Callable = validator(get_network_info)
        ...
        self.get_balances_by_addresses: Callable = validator(get_balances_by_addresses, True)
        self.get_general_information_by_addresses: Callable = validator(get_general_information_by_addresses, True)
        ...
        self.get_contracts_logs: Callable = validator(get_contracts_logs, True)
        self.contract_call: Callable = validator(
