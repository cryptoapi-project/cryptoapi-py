class Transactions:
    ...
    def get_transactions(self, block_height_or_hash=None, skip=None, limit=None, _from=None, to=None):
        ...
        self._utils.validate_data(self._models.api.btc.requests.get_transactions, params)

        params.update(api_key)

        validators.update({200: self._models.api.btc.responses.get_transactions})
    ...
    def get_transaction_by_hash(self, _hash):
        ...
        self._utils.validate_data(self._models.api.btc.requests.get_transaction_by_hash, params)

        validators.update({200: self._models.api.btc.responses.get_transaction_by_hash})
    ...
    def send_transaction(self, _hash):
        ...
        self._utils.validate_data(self._models.api.btc.requests.send_transaction, data)

        validators.update({200: self._models.api.btc.responses.send_transaction})
    ...
    def decode_transaction(self, _hash):
        ...
        self._utils.validate_data(self._models.api.btc.requests.decode_transaction, data)

        validators.update({200: self._models.api.btc.responses.decode_transaction})
