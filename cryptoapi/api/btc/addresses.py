...
class Addresses:
    ...
    def get_outputs_by_addresses(self,
        ...
        self._utils.validate_data(self._validators.btc.requests.get_outputs_by_addresses, params)

        params.update(api_key)

        validators.update({200: self._validators.btc.responses.get_outputs_by_addresses})
    ...
    def get_utxo_coin_addresses_info(self, addresses: List[str]) -> Union[List[Dict[str, Any]], error_static_type]:
        ...
        self._utils.validate_data(self._validators.btc.requests.get_utxo_coin_addresses_info, params)

        validators.update({200: self._validators.btc.responses.get_utxo_coin_addresses_info})
    ...
    def get_utxo_coin_addresses_history(self,
        ...
        self._utils.validate_data(self._validators.btc.requests.get_utxo_coin_addresses_history, params)

        params.update(api_key)

        validators.update({200: self._validators.btc.responses.get_utxo_coin_addresses_history})
