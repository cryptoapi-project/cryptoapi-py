...
class Contracts:
    ...
    def get_contracts_logs(
        ...
        self._utils.validate_data(self._validators.eth.requests.get_contracts_logs, params)
        ...
        validators.update({200: self._validators.eth.responses.get_contracts_logs})
    ...
    def contract_call(self, address: str, sender: str, amount: int,
        ...
        self._utils.validate_data(self._validators.eth.requests.contract_call_params, params)
        self._utils.validate_data(self._validators.eth.requests.contract_call_body, data)

        validators.update({200: self._validators.eth.responses.contract_call})
    ...
    def get_contract_general_information(self, address: str) -> Union[Dict[str, str], error_static_type]:
        ...
        self._utils.validate_data(self._validators.eth.requests.get_contract_general_information, params)

        validators.update({200: self._validators.eth.responses.get_contract_general_information})
