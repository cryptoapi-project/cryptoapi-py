class Common:
    ...
    def get_network_info(self):
        ...
        validators.update({200: self._models.api.eth.responses.get_network_info})
    ...
    def estimate_gas(self, _from, to, data, value):
        ...
        self._utils.validate_data(self._models.api.eth.requests.estimate_gas, data)

        validators.update({200: self._models.api.eth.responses.estimate_gas})
