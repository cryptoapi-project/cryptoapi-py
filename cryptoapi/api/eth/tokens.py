...
class Tokens:
    ...
    def get_tokens(
        ...
        self._utils.validate_data(self._validators.eth.requests.get_tokens, params)
        ...
        validators.update({200: self._validators.eth.responses.get_tokens})
    ...
    def get_token_transfers_by_token_address(
        ...
        self._utils.validate_data(self._validators.eth.requests.get_token_transfers_by_token_address, params)
        ...
        validators.update({200: self._validators.eth.responses.get_token_transfers_by_token_address})
    ...
    def get_token_contract(self, address: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.eth.requests.get_token_contract, params)

        validators.update({200: self._validators.eth.responses.get_token_contract})
