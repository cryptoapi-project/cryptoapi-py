class Rates:
    ...
    def get_coins_rates(self, coins):
        ...
        return self._http.get(url='/{}/'.format(params['coins']), params=api_key, validators=validators)
    ...
    def get_coins_history(self, coins):
        ...
        return self._http.get(url='/{}/history'.format((params['coins'])), params=api_key, validators=validators)
