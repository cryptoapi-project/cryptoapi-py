...
class Transactions:
    ...
    def get_transactions(
        ...
        self._utils.validate_data(self._validators.klay.requests.get_transactions, params)

        params.update(api_key)

        validators.update({200: self._validators.klay.responses.get_transactions})
    ...
    def get_transaction_information(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.klay.requests.get_transaction_information, params)

        validators.update({200: self._validators.klay.responses.get_transaction_information})
    ...
    def get_transaction_receipt(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.klay.requests.get_transaction_receipt, params)

        validators.update({200: self._validators.klay.responses.get_transaction_receipt})
    ...
    def send_transaction(self, tx: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.klay.requests.send_transaction, data)

        validators.update({200: self._validators.klay.responses.send_transaction})
    ...
    def decode_transaction(self, tx: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.klay.requests.decode_transaction, data)

        validators.update({200: self._validators.klay.responses.decode_transaction})
