class PushNotifications:
    ...
    def subscribe_to_addresses_notifications(self, addresses, firebase_token):
        ...
        self._utils.validate_data(self._models.api.klay.requests.subscribe_to_addresses_notifications_body, data)

        validators.update({200: self._models.api.klay.responses.subscribe_to_addresses_notifications})
    ...
    def unsubscribe_from_addresses_notifications(self, addresses, firebase_token):
        ...
        self._utils.validate_data(self._models.api.klay.requests.unsubscribe_from_addresses_notifications, params)
