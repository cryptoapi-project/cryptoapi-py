...
class Common:
    ...
    def get_network_info(self) -> Dict[str, Any]:
        ...
        validators.update({200: self._validators.klay.responses.get_network_info})
    ...
    def estimate_gas(self, _from: str, to: str, data: str, value: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.klay.requests.estimate_gas, post_data)

        validators.update({200: self._validators.klay.responses.estimate_gas})
