class Common:
    ...
    def get_network_info(self):
        ...
        validators.update({200: self._models.api.klay.responses.get_network_info})
    ...
    def estimate_gas(self, _from, to, data, value):
        ...
        self._utils.validate_data(self._models.api.klay.requests.estimate_gas, data)

        validators.update({200: self._models.api.klay.responses.estimate_gas})
