class Blocks:
    ...
    def get_block(self, block_number_or_hash):
        ...
        self._utils.validate_data(self._validators.api.klay.requests.get_block, params)
    ...
    def get_blocks(self, skip=None, limit=None):
        ...
        self._utils.validate_data(self._validators.api.klay.requests.get_blocks, params)

        validators.update({200: self._validators.api.klay.responses.get_blocks})
