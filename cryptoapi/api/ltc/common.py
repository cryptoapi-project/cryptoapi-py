class Common:
    ...
    def get_network_information(self):
        ...
        validators.update({200: self._validators.api.ltc.responses.get_network_information})
    ...
    def get_estimate_fee(self):
        ...
        validators.update({200: self._validators.api.ltc.responses.get_estimate_fee})
