...
class Transactions:
    ...
    def get_transactions(
        ...
        self._utils.validate_data(self._validators.ltc.requests.get_transactions, params)

        params.update(api_key)

        validators.update({200: self._validators.ltc.responses.get_transactions})
    ...
    def get_transaction_by_hash(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.ltc.requests.get_transaction_by_hash, params)
    ...
    def send_transaction(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.ltc.requests.send_transaction, data)

        validators.update({200: self._validators.ltc.responses.send_transaction})
    ...
    def decode_transaction(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.ltc.requests.decode_transaction, data)

        validators.update({200: self._validators.ltc.responses.decode_transaction})
