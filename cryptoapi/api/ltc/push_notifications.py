...
class PushNotifications:
    ...
    def subscribe_to_addresses_notifications(self, addresses: str, firebase_token: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(
            self._validators.ltc.requests.subscribe_to_addresses_notifications_params, params
        )
        self._utils.validate_data(self._validators.ltc.requests.subscribe_to_addresses_notifications_body, data)

        validators.update({200: self._validators.ltc.responses.subscribe_to_addresses_notifications})
    ...
    def unsubscribe_from_addresses_notifications(self, addresses: str,
        ...
        self._utils.validate_data(self._validators.ltc.requests.unsubscribe_from_addresses_notifications, params)
