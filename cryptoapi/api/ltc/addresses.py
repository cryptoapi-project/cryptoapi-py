...
class Addresses:
    ...
    def get_outputs_by_addresses(self, addresses, status, skip=None, limit=None):
        ...
        validate_data(
            self._models.api.ltc.requests.get_outputs_by_addresses,
            params
        )
        ...
        validators.update({
            200: self._models.api.ltc.responses.get_outputs_by_addresses
        })
    ...
    def get_utxo_coin_addresses_info(self, addresses):
        ...
        validate_data(
            self._models.api.ltc.requests.get_utxo_coin_addresses_info,
            params
        )

        validators.update({
            200: self._models.api.ltc.responses.get_utxo_coin_addresses_info
        })
    ...
    def get_utxo_coin_addresses_history(self, addresses, skip=None, limit=None):
        ...
        validate_data(
            self._models.api.ltc.requests.get_utxo_coin_addresses_history,
            params
        )
        ...
        validators.update({
            200: self._models.api.ltc.responses.get_utxo_coin_addresses_history
        })
