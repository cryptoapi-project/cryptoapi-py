...
class Blocks:
    ...
    def get_block(self, block_height_or_hash):
        ...
        validate_data(
            self._models.bch.requests.get_block,
            params
        )

        validators.update({
            200: self._models.bch.responses.get_block
        })
    ...
    def get_blocks(self, skip=None, limit=None):
        ...
        validate_data(
            self._models.bch.requests.get_blocks,
            params
        )

        validators.update({
            200: self._models.bch.responses.get_blocks
        })
