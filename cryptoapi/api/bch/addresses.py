...
class Addresses:
    ...
    def get_outputs_by_addresses(self, addresses, status, skip=None, limit=None):
        ...
        validators.update({
            200: self._models.api.bch.responses.get_outputs_by_addresses
        })
    ...
    def get_utxo_coin_addresses_info(self, addresses):
        ...
        validators.update({
            200: self._models.api.bch.responses.get_utxo_coin_addresses_info
        })
    ...
    def get_utxo_coin_addresses_history(self, addresses, skip=None, limit=None):
        ...
        validators.update({
            200: self._models.api.bch.responses.get_utxo_coin_addresses_history
        })
