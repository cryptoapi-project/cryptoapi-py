...
class Transactions:
    ...
    def get_transactions(
        ...
        self._utils.validate_data(self._validators.bch.requests.get_transactions, params)

        params.update(api_key)

        validators.update({200: self._validators.bch.responses.get_transactions})
    ...
    def get_transaction_by_hash(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.bch.requests.get_transaction_by_hash, params)

        validators.update({200: self._validators.bch.responses.get_transaction_by_hash})
    ...
    def send_transaction(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.bch.requests.send_transaction, data)

        validators.update({200: self._validators.bch.responses.send_transaction})
    ...
    def decode_transaction(self, _hash: str) -> Dict[str, Any]:
        ...
        self._utils.validate_data(self._validators.bch.requests.decode_transaction, data)

        validators.update({200: self._validators.bch.responses.decode_transaction})
