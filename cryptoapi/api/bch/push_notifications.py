...
class PushNotifications:
    ...
    def subscribe_to_addresses_notifications(self, addresses, firebase_token):
        ...
        validate_data(
            self._models.api.bch.requests.subscribe_to_addresses_notifications_body,
            data
        )

        validators.update({
            200: self._models.api.bch.responses.subscribe_to_addresses_notifications
        })
    ...
    def unsubscribe_from_addresses_notifications(self, addresses, firebase_token):
        ...
        validate_data(
            self._models.api.bch.requests.unsubscribe_from_addresses_notifications,
            params
        )
