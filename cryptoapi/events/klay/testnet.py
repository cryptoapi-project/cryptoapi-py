class Testnet:
    ...
    def on_block(self, callback, confirmations=0):
        ...
        return self._ws.on_event(['new_block',
                                  confirmations],
                                 callback,
                                 self._models.events.notifications.klay_block_notification)
    ...
    def on_address_transactions(self, address, callback, confirmations=0):
        ...
        return self._ws.on_event(['new_transaction',
                                  ...
                                  confirmations],
                                 callback,
                                 self._models.events.notifications.klay_transaction_notification)
    ...
    def on_token_transfers(self, token, address, callback, confirmations=0):
        self._utils.validate_data(self._models.events.address, address)
        self._utils.validate_data(self._models.events.token, token)
        self._utils.validate_data(self._models.events.confirmations, confirmations)
    ...
    def on_contract_log(self, address, callback, confirmations=0, _from=None, to=None, topics=None):
        ...
        self._utils.validate_data(self._models.events.confirmations, confirmations)
        if _from:
            self._utils.validate_data(self._models.events._from, _from)
        if to:
            self._utils.validate_data(self._models.events.to, to)
        if topics:
            self._utils.validate_data(self._models.events.topics, topics)
