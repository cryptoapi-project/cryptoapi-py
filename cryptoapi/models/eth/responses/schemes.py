from cryptoapi.models.utils import hex_type, string_type, integer_type, utc_type
...
get_block_information_by_block_number_or_hash = _block_item
...
get_information_about_the_latest_blocks_with_pagination = {
    ...
    'limit': integer_type,
    'count': integer_type,
    'items': {'type': 'list', 'schema': {'type': 'dict', 'schema': _block_item}}
}
...
get_transactions_by_addresses = {
    'addresses': {'type': 'list', 'schema': hex_type},
    'skip': string_type,
    'limit': integer_type,
    'items': {'type': 'list', 'schema': {'type': 'dict', 'schema': _transfer_item}},
    'count': integer_type
}
...
_transactions_item = {
    ...
    's': hex_type,
    'r': hex_type,
    'internal_transactions': {'type': 'list', 'schema': {'type': 'dict', 'schema': _internal_transactions}}
}
...
get_transaction_intersections_by_addresses = {
    ...
    'skip': string_type,
    'limit': integer_type,
    'items': {'type': 'list', 'schema': {'type': 'dict', 'schema': _transactions_item}},
    'count': integer_type
}
...
get_token_transfers_by_addresses = {
    ...
    'skip': integer_type,
    'limit': integer_type,
    'items': {'type': 'list', 'schema': {'type': 'dict', 'schema': _token_item}},
    'count': integer_type
}
...
get_tokens_balances_by_holders = {
    'count': integer_type,
    'items': {'type': 'list', 'schema': {'type': 'dict', 'schema': _balance_token_item}},
}
get_token_balance_by_holders_and_token = get_tokens_balances_by_holders
...
_receipt_logs = {
    'address': hex_type,
    'data': hex_type,
    'topics': {'type': 'list', 'schema': hex_type},
    'log_index': integer_type,
    'transaction_hash': hex_type,
    'transaction_index': integer_type,
    'block_hash': hex_type,
...
_receipt = {
    ...
    'gas_used': integer_type,
    'status': {'type': 'boolean'},
    'logs': {'type': 'list', 'schema': {'type': 'dict', 'schema': _receipt_logs}},
}

get_transaction_information = {
    'receipt': _receipt
}
get_transaction_information.update(_transactions_item)
...
get_transaction_receipt.update(_receipt)
...
get_contracts_logs = {
    ...
    'transaction_index': integer_type,
    'log_index': integer_type,
    'topics_indexed': {'type': 'list', 'schema': {'type': 'dict', 'schema': _topics_indexed}},
    'topics': {'type': 'list', 'schema': hex_type},
    'block_number': integer_type,
    'address': hex_type,
}
