...
from .config import block_number, client_api_key, trx_hash, trx_hex
...
class TransactionsTestCase(unittest.TestCase):
    ...
    def test_get_transactions(self):
        trx = self.client.get_transactions(block_number)
        self.assertNotIn('errors', trx)

    def test_get_transaction_by_hash(self):
        trx = self.client.get_transaction_by_hash(trx_hash)
        self.assertNotIn('errors', trx)

    def test_decode_transaction(self):
        decode_trx = self.client.decode_transaction(trx_hex)
